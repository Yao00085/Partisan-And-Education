...
!["State parisan control"](FileName.gif)
...
setnames(new_2010,col_name);setnames(new_2011,col_name);setnames(new_2012,col_name);setnames(new_2013,col_name)
setnames(new_2014,col_name);setnames(new_2015,col_name);setnames(new_2016,col_name);setnames(new_2017,col_name)
setnames(new_2018,col_name);setnames(new_2019,col_name);setnames(new_2020,col_name)
